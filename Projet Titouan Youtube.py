...
"""
Ce projet permet de télecharger des vidéos Youtube dans un emplacmeent spécifique

Consigne: Eviter de choisir comme emplacement des dossier comme téléchargeemnt ou nécessitant une autorisation
          Créer un dossir où vous voulez le stocker pour plus de facilité

Rappel : Ce projet est uniquement à but d'entrainement et ne doit pas être utilisé de manière à détourner des vidéos 

Fait par Pradoura Titouan en Calsse de Terminale générale option NSI Math
